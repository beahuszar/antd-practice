...
export function GazdasagiEsemenyek() {
  ...
  useEffect(() => {
    async function fetchCsv() {
      const readable = await fetch('data/gazdasagi-esemenyek.csv') // todo: read into how to better handle csv in webpack, 'antd-practice/data/gazdasagi-esemenyek.csv' for development
